/*
  # Blog Content Migration - Fixed

  1. Blog Posts
    - Insert 50 blog posts across 3 decision stages
    - Awareness (20 posts), Consideration (20 posts), Decision (10 posts)
    - Proper conflict handling to avoid duplicates

  2. Translations
    - Add Arabic and English translations for key articles
    - Use ON CONFLICT DO UPDATE to handle existing translations

  3. Tag Relationships
    - Link posts to relevant tags
    - Proper conflict handling for tag relationships
*/
...
INSERT INTO blog_posts (id, category_id, slug, image_url, author_name, published_at) VALUES
  ...
  ('10000001-0001-0001-0001-000000000001', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'what-is-erp-saudi-businesses', 'https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg', 'ToDoOps Team', '2024-01-15 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000002', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'signs-business-needs-erp-saudi', 'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg', 'ToDoOps Team', '2024-01-16 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000003', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'benefits-erp-sme-saudi', 'https://images.pexels.com/photos/3184418/pexels-photo-3184418.jpeg', 'ToDoOps Team', '2024-01-17 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000004', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'digital-transformation-saudi-erp', 'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg', 'ToDoOps Team', '2024-01-18 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000005', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'common-business-challenges-erp-saudi', 'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg', 'ToDoOps Team', '2024-01-19 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000006', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'erp-vs-spreadsheets-saudi', 'https://images.pexels.com/photos/3184287/pexels-photo-3184287.jpeg', 'ToDoOps Team', '2024-01-20 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000007', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'business-process-automation-saudi', 'https://images.pexels.com/photos/3184431/pexels-photo-3184431.jpeg', 'ToDoOps Team', '2024-01-21 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000008', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'inventory-management-basics-saudi', 'https://images.pexels.com/photos/3184317/pexels-photo-3184317.jpeg', 'ToDoOps Team', '2024-01-22 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000009', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'understanding-crm-saudi', 'https://images.pexels.com/photos/3184298/pexels-photo-3184298.jpeg', 'ToDoOps Team', '2024-01-23 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000010', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'importance-financial-management-saudi', 'https://images.pexels.com/photos/3184306/pexels-photo-3184306.jpeg', 'ToDoOps Team', '2024-01-24 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000011', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'data-security-erp-saudi', 'https://images.pexels.com/photos/3184357/pexels-photo-3184357.jpeg', 'ToDoOps Team', '2024-01-25 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000012', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'erp-supply-chain-efficiency-saudi', 'https://images.pexels.com/photos/3184394/pexels-photo-3184394.jpeg', 'ToDoOps Team', '2024-01-26 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000013', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'ai-erp-integration-ksa', 'https://images.pexels.com/photos/3184421/pexels-photo-3184421.jpeg', 'ToDoOps Team', '2024-01-27 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000014', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'employee-productivity-erp', 'https://images.pexels.com/photos/3184440/pexels-photo-3184440.jpeg', 'ToDoOps Team', '2024-01-28 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000015', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'understanding-cloud-erp-saudi', 'https://images.pexels.com/photos/3184458/pexels-photo-3184458.jpeg', 'ToDoOps Team', '2024-01-29 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000016', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'erp-business-growth-saudi', 'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg', 'ToDoOps Team', '2024-01-30 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000017', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'integrated-vs-standalone-software', 'https://images.pexels.com/photos/3184295/pexels-photo-3184295.jpeg', 'ToDoOps Team', '2024-01-31 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000018', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'kpis-saudi-business-erp', 'https://images.pexels.com/photos/3184299/pexels-photo-3184299.jpeg', 'ToDoOps Team', '2024-02-01 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000019', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'erp-improve-customer-service-saudi', 'https://images.pexels.com/photos/3184302/pexels-photo-3184302.jpeg', 'ToDoOps Team', '2024-02-02 10:00:00+00'),
  ('10000001-0001-0001-0001-000000000020', (SELECT id FROM blog_categories WHERE slug = 'erp-basics' LIMIT 1), 'project-management-basics-erp', 'https://images.pexels.com/photos/3184305/pexels-photo-3184305.jpeg', 'ToDoOps Team', '2024-02-03 10:00:00+00'),

  -- Consideration Stage (20 posts)
  ('20000001-0001-0001-0001-000000000001', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'odoo-vs-sap-saudi-comparison', 'https://images.pexels.com/photos/3184308/pexels-photo-3184308.jpeg', 'ToDoOps Team', '2024-02-04 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000002', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'odoo-features-overview-ksa', 'https://images.pexels.com/photos/3184311/pexels-photo-3184311.jpeg', 'ToDoOps Team', '2024-02-05 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000003', (SELECT id FROM blog_categories WHERE slug = 'industry-solutions' LIMIT 1), 'erp-construction-companies-saudi', 'https://images.pexels.com/photos/3184314/pexels-photo-3184314.jpeg', 'ToDoOps Team', '2024-02-06 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000004', (SELECT id FROM blog_categories WHERE slug = 'industry-solutions' LIMIT 1), 'erp-manufacturing-saudi', 'https://images.pexels.com/photos/3184320/pexels-photo-3184320.jpeg', 'ToDoOps Team', '2024-02-07 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000005', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'cloud-vs-onpremise-erp-saudi', 'https://images.pexels.com/photos/3184323/pexels-photo-3184323.jpeg', 'ToDoOps Team', '2024-02-08 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000006', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'erp-integration-odoo', 'https://images.pexels.com/photos/3184326/pexels-photo-3184326.jpeg', 'ToDoOps Team', '2024-02-09 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000007', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'odoo-modules-explained', 'https://images.pexels.com/photos/3184329/pexels-photo-3184329.jpeg', 'ToDoOps Team', '2024-02-10 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000008', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'erp-roi-calculation-saudi', 'https://images.pexels.com/photos/3184332/pexels-photo-3184332.jpeg', 'ToDoOps Team', '2024-02-11 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000009', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'choosing-right-erp-system-saudi', 'https://images.pexels.com/photos/3184335/pexels-photo-3184335.jpeg', 'ToDoOps Team', '2024-02-12 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000010', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'odoo-crm-module-saudi', 'https://images.pexels.com/photos/3184338/pexels-photo-3184338.jpeg', 'ToDoOps Team', '2024-02-13 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000011', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'odoo-accounting-module-saudi', 'https://images.pexels.com/photos/3184341/pexels-photo-3184341.jpeg', 'ToDoOps Team', '2024-02-14 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000012', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'odoo-hr-module-saudi', 'https://images.pexels.com/photos/3184344/pexels-photo-3184344.jpeg', 'ToDoOps Team', '2024-02-15 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000013', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'odoo-inventory-module-saudi', 'https://images.pexels.com/photos/3184347/pexels-photo-3184347.jpeg', 'ToDoOps Team', '2024-02-16 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000014', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'sales-management-odoo-saudi', 'https://images.pexels.com/photos/3184350/pexels-photo-3184350.jpeg', 'ToDoOps Team', '2024-02-17 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000015', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'supply-chain-management-odoo-saudi', 'https://images.pexels.com/photos/3184353/pexels-photo-3184353.jpeg', 'ToDoOps Team', '2024-02-18 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000016', (SELECT id FROM blog_categories WHERE slug = 'industry-solutions' LIMIT 1), 'odoo-retail-businesses-saudi', 'https://images.pexels.com/photos/3184356/pexels-photo-3184356.jpeg', 'ToDoOps Team', '2024-02-19 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000017', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'customizing-odoo-saudi-business', 'https://images.pexels.com/photos/3184359/pexels-photo-3184359.jpeg', 'ToDoOps Team', '2024-02-20 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000018', (SELECT id FROM blog_categories WHERE slug = 'industry-solutions' LIMIT 1), 'odoo-service-businesses-saudi', 'https://images.pexels.com/photos/3184362/pexels-photo-3184362.jpeg', 'ToDoOps Team', '2024-02-21 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000019', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'evaluating-erp-vendors-saudi', 'https://images.pexels.com/photos/3184365/pexels-photo-3184365.jpeg', 'ToDoOps Team', '2024-02-22 10:00:00+00'),
  ('20000001-0001-0001-0001-000000000020', (SELECT id FROM blog_categories WHERE slug = 'odoo-features' LIMIT 1), 'odoo-community-vs-enterprise-sme-saudi', 'https://images.pexels.com/photos/3184368/pexels-photo-3184368.jpeg', 'ToDoOps Team', '2024-02-23 10:00:00+00'),

  -- Decision Stage (10 posts)
  ('30000001-0001-0001-0001-000000000001', (SELECT id FROM blog_categories WHERE slug = 'implementation-guide' LIMIT 1), 'odoo-implementation-process-ksa', 'https://images.pexels.com/photos/3184371/pexels-photo-3184371.jpeg', 'ToDoOps Team', '2024-02-24 10:00:00+00'),
  ('30000001-0001-0001-0001-000000000002', (SELECT id FROM blog_categories WHERE slug = 'implementation-guide' LIMIT 1), 'odoo-pricing-guide-saudi', 'https://images.pexels.com/photos/3184374/pexels-photo-3184374.jpeg', 'ToDoOps Team', '2024-02-25 10:00:00+00'),
  ('30000001-0001-0001-0001-000000000003', (SELECT id FROM blog_categories WHERE slug = 'implementation-guide' LIMIT 1), 'erp-implementation-timeline-saudi', 'https://images.pexels.com/photos/3184377/pexels-photo-3184377.jpeg', 'ToDoOps Team', '2024-02-26 10:00:00+00'),
  ('30000001-0001-0001-0001-000000000004', (SELECT id FROM blog_categories WHERE slug = 'implementation-guide' LIMIT 1), 'odoo-training-best-practices-saudi', 'https://images.pexels.com/photos/3184380/pexels-photo-3184380.jpeg', 'ToDoOps Team', '2024-02-27 10:00:00+00'),
  ('30000001-0001-0001-0001-000000000005', (SELECT id FROM blog_categories WHERE slug = 'implementation-guide' LIMIT 1), 'data-migration-odoo-saudi', 'https://images.pexels.com/photos/3184383/pexels-photo-3184383.jpeg', 'ToDoOps Team', '2024-02-28 10:00:00+00'),
  ('30000001-0001-0001-0001-000000000006', (SELECT id FROM blog_categories WHERE slug = 'implementation-guide' LIMIT 1), 'odoo-support-maintenance-saudi', 'https://images.pexels.com/photos/3184386/pexels-photo-3184386.jpeg', 'ToDoOps Team', '2024-03-01 10:00:00+00'),
  ('30000001-0001-0001-0001-000000000007', (SELECT id FROM blog_categories WHERE slug = 'implementation-guide' LIMIT 1), 'erp-project-success-factors-saudi', 'https://images.pexels.com/photos/3184389/pexels-photo-3184389.jpeg', 'ToDoOps Team', '2024-03-02 10:00:00+00'),
  ('30000001-0001-0001-0001-000000000008', (SELECT id FROM blog_categories WHERE slug = 'implementation-guide' LIMIT 1), 'post-implementation-optimization-saudi', 'https://images.pexels.com/photos/3184392/pexels-photo-3184392.jpeg', 'ToDoOps Team', '2024-03-03 10:00:00+00'),
  ('30000001-0001-0001-0001-000000000009', (SELECT id FROM blog_categories WHERE slug = 'implementation-guide' LIMIT 1), 'technical-support-odoo-saudi', 'https://images.pexels.com/photos/3184395/pexels-photo-3184395.jpeg', 'ToDoOps Team', '2024-03-04 10:00:00+00'),
  ('30000001-0001-0001-0001-000000000010', (SELECT id FROM blog_categories WHERE slug = 'implementation-guide' LIMIT 1), 'why-choose-certified-odoo-partner-saudi', 'https://images.pexels.com/photos/3184398/pexels-photo-3184398.jpeg', 'ToDoOps Team', '2024-03-05 10:00:00+00')
ON CONFLICT (slug) DO NOTHING;

-- Insert Arabic translations for key articles with proper conflict handling
...
-- Insert English translations for key articles with proper conflict handling
INSERT INTO blog_post_translations (post_id, lang, title, content, meta_description, keywords) VALUES
...
-- Insert tag relationships for the articles using existing tag IDs with proper conflict handling
